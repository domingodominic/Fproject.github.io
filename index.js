...
skillChild.item(2).addEventListener("mouseover", function () {
  skills.style.background = `url('sass.jpg')`;

  // skillChild.item(2).style.boxShadow =
...
function tagEmployee(employee = new employee(generateEmployee())) {
  employee.department = "USER EXPERINCE";
  employee.salary = Math.floor(Math.random() * 19999);

  return employee;
}

console.log(tagEmployee(new employee(generateEmployee())));
